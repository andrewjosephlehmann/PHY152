...
\textbar{By observing the graph, we may observe that the equilibrium length of bond $x_0$ is $13\times10^{-5}m$. With this knowledge, we may approximate the spring constant and find the vibrational frequency of the diatomic molecule HCl. The function the graph illustrates is:}
